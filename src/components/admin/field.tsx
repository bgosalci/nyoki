...
export function Field({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      {hint ? (
        <p id={hintId} className="text-xs text-black/50 dark:text-white/50">
          {hint}
        </p>
      ) : null}
...
export const inputClass =
  "rounded-md border border-black/15 bg-white px-3 py-2 text-sm outline-none focus:border-black/40 aria-[invalid]:border-red-400 dark:border-white/15 dark:bg-white/5 dark:focus:border-white/40";
